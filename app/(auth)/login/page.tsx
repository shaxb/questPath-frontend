      ...
      <div className="w-full lg:w-[30%] bg-white flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-green-500 mb-2">QuestPath</h1>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            {successMessage && (
              <div className="bg-green-50 border-2 border-green-400 text-green-700 px-4 py-3 rounded-xl text-sm">
                {successMessage}
              </div>
            )}
            ...
            {/* Error message */}
            {error && (
              <div className="bg-red-50 border-2 border-red-400 text-red-700 px-4 py-3 rounded-xl text-sm">
                {error}
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-green-500 transition-colors text-gray-900"
